...
console.log(
  "preregistration-check: 2 strata; 20-committed-pair analysis floor; 60-attempt cap; 5 Bonferroni-protected exact order-statistic looks; descriptive bootstrap only; 120-launch permit envelope; authorization not instantiated",
);
