...
const foundationSchemas = [
  ...
  "cad-mesh-repair-build-manifest.schema.json",
  "cad-mesh-repair-contract.schema.json",
  "cad-mesh-repair-evidence.schema.json",
  "chrome-package-manifest.schema.json",
  "ml-numeric-kernels-fixture.schema.json",
  "ml-numeric-kernels-build.schema.json",
  "ml-numeric-kernels-output.schema.json",
  "ml-numeric-kernels-evidence.schema.json",
