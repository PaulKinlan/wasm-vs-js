const form = document.querySelector("#crypto-contract-form");
const start = document.querySelector("#crypto-start");
const cancel = document.querySelector("#crypto-cancel");
const status = document.querySelector("#crypto-status");
const output = document.querySelector("#crypto-output");
