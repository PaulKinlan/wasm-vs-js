const start = document.querySelector("#vg-start");
const cancel = document.querySelector("#vg-cancel");
const target = document.querySelector("#vg-target");
const status = document.querySelector("#vg-status");
const output = document.querySelector("#vg-result");
