const target = document.querySelector("#sf-target");
const start = document.querySelector("#sf-start");
const cancel = document.querySelector("#sf-cancel");
const status = document.querySelector("#sf-status");
const progress = document.querySelector("#sf-progress");
const result = document.querySelector("#sf-result");
let worker = null;
let token = 0;
let timeout = 0;
