...
Generated: 2026-08-03T22:21:13.404Z
...
| ------------------------------ | ------------------- | ----------------------- | ------------------- | ------------- |
| **JavaScript** (V8 JIT)        | 0 B                 | 0.00 ms                 | 109.65 ms           | 1.00×         |
| **Raw WAT** (Handwritten)      | 96 B                | 0.0017 ms               | 52.66 ms            | 2.08×         |
| **AssemblyScript** (asc -O3)   | 94 B                | 0.0009 ms               | 52.44 ms            | 2.09×         |
| **C / Wasm** (Clang -nostdlib) | 757 B               | 0.002 ms                | 39.99 ms            | 2.74×         |
| **C++ / Wasm** (Clang++ -O3)   | 759 B               | 0.0017 ms               | 40.21 ms            | 2.73×         |

### 2. Fast Fourier Transform Butterfly (`fft-kernel`, 512 elements, 2,000 iterations)

| Language / Toolchain           | Binary Size (bytes) | Cold Instantiation (ms) | Warm Execution (ms) | Speedup vs JS |
| ------------------------------ | ------------------- | ----------------------- | ------------------- | ------------- |
| **JavaScript** (V8 JIT)        | 0 B                 | 0.00 ms                 | 11.1 ms             | 1.00×         |
| **AssemblyScript** (asc -O3)   | 2479 B              | 0.0014 ms               | 8.66 ms             | 1.28×         |
| **C / Wasm** (Clang -nostdlib) | 1149 B              | 0.0017 ms               | 8.39 ms             | 1.32×         |
| **C++ / Wasm** (Clang++ -O3)   | 1151 B              | 0.0017 ms               | 8.81 ms             | 1.26×         |
...
| -------------------------------- | ------------------- | ----------------------- | ---------------------------- |
| **Kotlin / WasmGC** (Kotlin 2.3) | 36961 B (~37 KB)    | 0.0656 ms               | 18 imports (GC, JS-builtins) |
