const target = document.querySelector("#cpb-target");
const form = document.querySelector("#controls");
const start = document.querySelector("#cpb-start");
const cancel = document.querySelector("#cpb-cancel");
const status = document.querySelector("#cpb-status");
...
function begin() {
  ...
  const owned = new Worker("/benchmarks/cad-parametric-bracket/worker.js", { type: "module" });
  worker = owned;
  start.disabled = true;
