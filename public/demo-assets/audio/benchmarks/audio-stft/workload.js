...
import { fftRadix2, generateTwiddleTable } from "../audio-fft/workload.js";
...
export function stftInto(input, frameSize, hopSize, window, twiddle, scratch, spectrogram) {
...
export function stft(input, frameSize = FRAME_SIZE, hopSize = HOP_SIZE) {
  const numFrames = 1 + Math.floor((input.length - frameSize) / hopSize);
