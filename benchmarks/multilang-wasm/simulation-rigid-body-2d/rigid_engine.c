...
__attribute__((visibility("default"))) uint32_t fixture_ptr(void){return(uint32_t)(uintptr_t)fixture;}
__attribute__((visibility("default"))) uint32_t result_ptr(void){return(uint32_t)(uintptr_t)&result;}
