...
typedef struct { float cx,cy,cz,r,cr,cg,cb,emit; } Sphere;
...
static const Node nodes[13] = {
 ...
 {5,6,-1,-1.15f,-1,-0.65f,1.1f,2.8f,0.85f},
 {7,8,-1,-1000,-2001,-2001,1000,1000,1000},
 {9,10,-1,-2001,-1000,-1000,2001,1000,1000},
 {-1,-1,4,-1.15f,-1,-0.25f,-0.05f,0.1f,0.85f},
 {11,12,-1,-0.5f,-1,-0.65f,1.1f,2.8f,0.5f},
 ...
 {-1,-1,5,0.2f,-1,-0.65f,1.1f,-0.1f,0.25f},
 {-1,-1,6,-0.5f,1.8f,-0.5f,0.5f,2.8f,0.5f}
};

static float minf(float a,float b){return a<b?a:b;} static float maxf(float a,float b){return a>b?a:b;}
...
static Vec3 vmul(Vec3 a,float s){return (Vec3){a.x*s,a.y*s,a.z*s};}
static float dot(Vec3 a,Vec3 b){return a.x*b.x+(a.y*b.y+a.z*b.z);}
static Vec3 norm(Vec3 a){float d=dot(a,a);if(d==0.0f)return (Vec3){0,1,0};float l=__builtin_sqrtf(d);return (Vec3){a.x/l,a.y/l,a.z/l};}
...
static uint32_t seed_for(uint32_t pixel,uint32_t sample){return SEED^(pixel*0x9e3779b9u)^(sample*0x85ebca6bu);}
