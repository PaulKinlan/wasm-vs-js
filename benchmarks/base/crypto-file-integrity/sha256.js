// Controlled scalar SHA-256. No WebCrypto, native hash intrinsic, SIMD, or fallback.
...
export class ControlledSha256 {
  ...
  digest() {
    ...
    for (let i = 0; i < 8; i++) this.block[63 - i] = Number((bitLength >> BigInt(i * 8)) & 255n);
    this.compress(this.block);
