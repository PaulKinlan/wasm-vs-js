...
const SQLITE_NOTEBOOK_RUNTIME_MANIFEST_SHA256 =
  "44ff0378a9dbaa3fb1b1f16621ddc41b8b65ef59450eece5d3290ab1bd0c172d";
...
const routes = new Map<string, [string, string, boolean?]>([
  ...
  ["/measurement-model.js", ["public/measurement-model.js", "text/javascript; charset=utf-8"]],
  ["/coverage.js", ["public/coverage.js", "text/javascript; charset=utf-8"]],
  ...
  ["/dom-hosts/base-dom-dependent-form-validation.js", [
  ...
  ["/dom-hosts/base-dom-virtualized-grid.js", [
  ...
  ["/dom-hosts/base-text-gc-document-edit.js", [
    "public/dom-hosts/base-text-gc-document-edit.js",
    "text/javascript; charset=utf-8",
  ]],
  ...
  ["/artifacts/server-ssr-template-v1-multilang/fixture.bin", [
    "public/artifacts/server-ssr-template-v1-multilang/fixture.bin",
    "application/octet-stream",
  ]],
  ["/artifacts/regex-automata-duel-multilang/fixture.bin", [
    "public/artifacts/regex-automata-duel-multilang/fixture.bin",
    "application/octet-stream",
  ]],
  ["/artifacts/text-markdown-cms-multilang/fixture.bin", [
    "public/artifacts/text-markdown-cms-multilang/fixture.bin",
    "application/octet-stream",
  ]],
...
// module additionally needs its dart2wasm-generated glue (.mjs).
{
  ...
  for (
    const file of [
      ...
      "network-pcap-decode.manifest.json",
      "graphics-cpu-path-tracer.manifest.json",
      "cad-mesh-repair.manifest.json",
      "cad-parametric-bracket.manifest.json",
      "crypto-authenticated-stream.manifest.json",
      "database-olap-chart.manifest.json",
      "document-pdf-viewer.manifest.json",
      "game-ecs-frame-update.manifest.json",
      "image-editing.manifest.json",
      "ml-numeric-kernels.manifest.json",
      "simulation-nbody-cloth.manifest.json",
      "simulation-rigid-body-2d.manifest.json",
      "serialization-json-telemetry.manifest.json",
      "audio-fft.manifest.json",
      "graphics-gltf-viewer.manifest.json",
      "audio-fir.manifest.json",
      "audio-stft.manifest.json",
      "crypto-file-integrity.manifest.json",
      "base-dom-todomvc-journey.manifest.json",
      "text-diff-patch.manifest.json",
      "numeric-polybench-panel.manifest.json",
      "sum-u32.manifest.json",
      "fft-kernel.manifest.json",
      "ml-gemm.manifest.json",
      "ml-dense-mlp.manifest.json",
      "multilang-wasm.manifest.json",
      "audio-webaudio-effects-v1.manifest.json",
      "archive-zip-workspace-v1.manifest.json",
      "ml-keyword-spotting-v1.manifest.json",
      "text-regex-log-scan.manifest.json",
      "dom-grid-movement.manifest.json",
      "dom-keyed-list-mutation.manifest.json",
      "dom-nested-tree-mutation.manifest.json",
      "dom-table-sort-filter-pagination.manifest.json",
      "dom-dependent-form-validation.manifest.json",
      "vdom-diff-patch.manifest.json",
      "text-gc-document-edit.manifest.json",
      "game-canvas-arcade.manifest.json",
      "game-canvas-entity-pathfinding.manifest.json",
      "game-dom-tactics-grid.manifest.json",
      "dom-virtualized-grid-v1.manifest.json",
      "server-ssr-template-v1.manifest.json",
      "regex-automata-duel-demo.manifest.json",
      "text-markdown-cms.manifest.json",
      "serialization-protobuf-gateway.manifest.json",
      "crypto-file-integrity.manifest.json",
      "ml-gemm.manifest.json",
      "multilang-wasm.manifest.json",
    ]
  ...
  for (
    const file of [
      ...
      "fft_opt_c.wasm",
      "gemm_simd_c.wasm",
      "image_kernels_asc.wasm",
      "image_kernels_c.wasm",
      "image_kernels_cpp.wasm",
      "image_kernels_dart.mjs",
      "image_kernels_dart.wasm",
      "image_kernels_rs.wasm",
      "mesh_repair_c.wasm",
      "mesh_repair_cpp.wasm",
      "mesh_repair_dart.mjs",
      ...
      "nbody_step_rs.wasm",
      "numeric_kernels_cpp.wasm",
      "numeric_kernels_dart.mjs",
      ...
      "rigid_dart.wasm",
      "rigid_rs.wasm",
      "audio_dsp_kernel_asc.wasm",
      "audio_dsp_kernel_c.wasm",
      "audio_dsp_kernel_cpp.wasm",
      "audio_dsp_kernel_rs.wasm",
      "zip_kernel_asc.wasm",
      "zip_kernel_c.wasm",
      "zip_kernel_cpp.wasm",
      "zip_kernel_rs.wasm",
      ...
      "kws_kernel_cpp.wasm",
      "kws_kernel_rs.wasm",
      "grid_kernel_asc.wasm",
      "grid_kernel_c.wasm",
      "grid_kernel_cpp.wasm",
      "grid_kernel_rs.wasm",
      "keyed_list_kernel_asc.wasm",
      "keyed_list_kernel_c.wasm",
      "keyed_list_kernel_cpp.wasm",
      "keyed_list_kernel_rs.wasm",
      "nested_tree_kernel_asc.wasm",
      "nested_tree_kernel_c.wasm",
      "nested_tree_kernel_cpp.wasm",
      "nested_tree_kernel_rs.wasm",
      "table_sort_kernel_asc.wasm",
      "table_sort_kernel_c.wasm",
      "table_sort_kernel_cpp.wasm",
      "table_sort_kernel_rs.wasm",
      "form_validate_kernel_asc.wasm",
      "form_validate_kernel_c.wasm",
      "form_validate_kernel_cpp.wasm",
      "form_validate_kernel_rs.wasm",
      "vdom_kernel_asc.wasm",
      "vdom_kernel_c.wasm",
      "vdom_kernel_cpp.wasm",
      "vdom_kernel_rs.wasm",
      "gc_document_kernel_asc.wasm",
      "gc_document_kernel_c.wasm",
      "gc_document_kernel_cpp.wasm",
      "gc_document_kernel_rs.wasm",
      "arcade_kernel_asc.wasm",
      "arcade_kernel_c.wasm",
      "arcade_kernel_cpp.wasm",
      "arcade_kernel_rs.wasm",
      "pathfinding_kernel_asc.wasm",
      "pathfinding_kernel_c.wasm",
      ...
      "grid_trace_kernel_asc.wasm",
      "grid_trace_kernel_c.wasm",
      "grid_trace_kernel_cpp.wasm",
      "grid_trace_kernel_rs.wasm",
      "server_ssr_kernel_asc.wasm",
      "server_ssr_kernel_c.wasm",
      "server_ssr_kernel_cpp.wasm",
      "server_ssr_kernel_rs.wasm",
      "regex_scan_kernel_asc.wasm",
      "regex_scan_kernel_c.wasm",
      "regex_scan_kernel_cpp.wasm",
      "regex_scan_kernel_rs.wasm",
      "markdown_cms_kernel_asc.wasm",
      "markdown_cms_kernel_c.wasm",
      "markdown_cms_kernel_cpp.wasm",
      "markdown_cms_kernel_rs.wasm",
      "protobuf_gateway_kernel_asc.wasm",
      "protobuf_gateway_kernel_c.wasm",
      "protobuf_gateway_kernel_cpp.wasm",
      "protobuf_gateway_kernel_rs.wasm",
      "scan_log_opt_c.wasm",
      "sum_u32_opt_c.wasm",
      "telemetry_c.wasm",
      "telemetry_asc.wasm",
